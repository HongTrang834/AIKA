...
const ProfileForm: React.FC<ProfileFormProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-24 mb-0 border border-slate-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Account Created Date</label>
          <input
            type="text"
            value={createdAt}
            disabled
