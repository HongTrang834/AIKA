  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      >
        ...
        <div>
          <h1 className="text-4xl font-bold text-slate-900">Grammar Details</h1>          <p className="text-slate-500">Back to search results</p>
        </div>
      </motion.div>
        ...
        <motion.div
          ...
          <div className="mt-8 pt-8 border-t border-slate-200">
            ...
            <div className="bg-slate-50 p-6 rounded-xl prose prose-sm max-w-none">
              <p className="text-slate-900 leading-relaxed whitespace-pre-wrap">                {grammar.explanation}
              </p>
            </div>
          </div>
